...
**Note:** Data is pre-categorized by the data aggregation layer into 'focus' and 'other' categories based on strategic topic keywords (mainframe, COBOL, legacy modernization, code comprehension, etc.). Use this categorization for the split report format.
...
The report MUST be split into TWO sections based on topic relevance:

#### Section 1: FOCUS TOPIC OPPORTUNITIES (Full Detail)
For opportunities matching focus topics (mainframe, COBOL, legacy, code comprehension, etc.):
- Full detailed analysis with all metrics
- Complete action items and recommendations
- Implementation roadmap with specific steps
- Meta improvement suggestions

#### Section 2: OTHER OPPORTUNITIES (Summary Only)
For non-focus opportunities - use CONDENSED format to save tokens:
- Simple table listing: Type | Item | Key Metric | Opportunity Score
- NO detailed analysis
- NO action items
- Just enough info for quality control

**Example Other Opportunities table format:**
```markdown
### Other Opportunities (Quality Control)

| Type | Item | Key Metric | Score |
|------|------|------------|-------|
| CTR | /learn/confluence/ultimate-guide | 14K missed clicks | 99 |
| Quick Win | github copilot pricing | pos 11.4, 5K imp | 97 |
| Declining | /learn/mermaid-js/guide | -25% traffic | 74 |
| Trending | developer productivity tools | +100% growth | 76 |
```

This structure ensures:
1. Focus topics get full attention and detailed analysis
2. Other topics are visible for quality control (catch miscategorized items)
3. Token usage minimized for non-priority content
...
**IMPORTANT:** Only include FOCUS TOPIC content in this section. Use the 'focus' data from the categorized opportunities. Non-focus content goes in "Other Opportunities" section at the end.

#### 🔥 URGENT (Do This Week) - FOCUS TOPICS ONLY
...
[Continue with top 3-5 urgent items from FOCUS topics]

---

#### ⚡ HIGH PRIORITY (Do This Month) - FOCUS TOPICS ONLY

**1. [Action Name]**
[Same format, slightly less urgent]

[List focus topic high-priority items]

---

#### 📌 MEDIUM PRIORITY (Plan for Next Month) - FOCUS TOPICS ONLY

**1. [Action Name]**
[Abbreviated format for medium priority]

[List focus topic medium-priority items]
...
This section lists NON-FOCUS topic opportunities in condensed format. These are shown for quality control to catch items that might be miscategorized. Review this section to identify if any items should be added to focus topic keywords.

Use the 'other' data from categorized opportunities. Present in simple table format:

| Type | Item | Key Metric | Score |
|------|------|------------|-------|
| CTR | [URL] | [X]K missed clicks | [XX] |
| Quick Win | [keyword] | pos [X], [X]K imp | [XX] |
| Declining | [URL] | -[X]% traffic | [XX] |
| Trending | [query] | +[X]% growth | [XX] |

**Note:** If you find items in "Other" that should be focus topics, recommend adding keywords to `FOCUS_TOPIC_KEYWORDS` in `data_sources/modules/data_aggregator.py`.
